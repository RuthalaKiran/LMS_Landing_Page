...
const Heroslide = () => {
  return (
    <div className="h-auto pt-10 w-full flex items-center justify-center">
      <Swiper
        slidesPerView={1}
        spaceBetween={0}
        loop={true}
      ...
      >
        ...
        <div className="absolute z-30 flex justify-between w-full top-1/2 transform -translate-y-1/2 px-2 sm:px-4">
          <div
            className="swiper-button-prev-custom cursor-pointer text-white text-3xl sm:text-4xl rounded-full w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center hover:bg-white/20 transition-all duration-300"
          >
            &lt;
          </div>
          <div
            className="swiper-button-next-custom cursor-pointer text-white text-3xl sm:text-4xl rounded-full w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center hover:bg-white/20 transition-all duration-300"
          >
            &gt;
          </div>
        </div>
